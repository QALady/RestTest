(function() {
	...
	myApp.controller('RegCtrl', ['$scope', '$http', '$uibModal', function($scope, $http, $uibModal) {
		var vm = this;
		vm.resultFlag = false;
		vm.currentPage = 0;
	    vm.pageSize = 6;
	    vm.searchOptionA = [{key: 'questionId', value:'Question #'},{key:'question', value:'Question'},{key:'answer', value:'Answer'}];
