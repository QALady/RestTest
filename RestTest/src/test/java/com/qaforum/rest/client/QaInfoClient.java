...
public final class QaInfoClient {
	...
	public static void main(final String[] args) throws IOException {
		...
		final FileDataBodyPart filePart2 = new FileDataBodyPart("file",
				new File("G:/3D_Funny_Cartoons_Wallpaper-_1366x768_3.jpg"));
		final FormDataMultiPart formDataMultiPart = new FormDataMultiPart();
		final FormDataMultiPart multipart = (FormDataMultiPart) formDataMultiPart
				.field("qaId", "21").bodyPart(filePart2);

		final WebTarget target = client
				.target("http://localhost:8080/RestTest/webapi/qaInfo/uploadQaImage");
